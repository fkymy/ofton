...
Post.create(author: 'yushi', body: body1, comments_count: 3)
Post.create(author: 'yushi', body: body2, comments_count: 2)
Post.create(author: 'yushi', body: body3, comments_count: 1)
Post.create(author: 'yushi', body: body3, comments_count: 0)
Post.create(author: 'yushi', body: body1, comments_count: 3)
Post.create(author: 'yushi', body: body2, comments_count: 2)
Post.create(author: 'yushi', body: body3, comments_count: 1)
Post.create(author: 'yushi', body: body1, comments_count: 3)
